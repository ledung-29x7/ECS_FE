            ...
            <ul className="menu-inner py-1">
                ...
                <li className="menu-item">
                    <a href="javascript:void(0);" className="menu-link menu-toggle">
                        ...
                        <div data-i18n="eCommerce">Manage Service</div>
                    </a>
                    <ul className="menu-sub">
                        <li className="menu-item">
                            <a href="/productService" className="menu-link">
                                <div data-i18n="Dashboard">Product Service</div>
                            </a>
                        </li>
                        <li className="menu-item">
                            <a href="/service" className="menu-link">
                                <div data-i18n="Products">Service</div>
                            </a>
                        </li>
                        <li className="menu-item">
                            <a href="javascript:void(0);" className="menu-link menu-toggle">
                    ...
                    <ul className="menu-sub">
                        ...
                        <li className="menu-item">
                            <a href="/employee" className="menu-link">
                                <div data-i18n="Products">Employee</div>
                            </a>
                        </li>
                        <li className="menu-item">
                            <a href="/department" className="menu-link">
                                <div data-i18n="Products">Department</div>
                            </a>
                        </li>
                        <li className="menu-item">
                            <a href="/callHistory" className="menu-link">
                                <div data-i18n="Products">Call History</div>
                            </a>
                        </li>
                ...
                <li className="menu-item">
                    <a href="javascript:void(0);" className="menu-link menu-toggle">
                        <i className="menu-icon tf-icons ri-shopping-bag-3-line" />
                        <div data-i18n="Manage Employee">Manage Client</div>
                    </a>
                    <ul className="menu-sub">
                        
                        <li className="menu-item">
                            <a href="/manageCliet" className="menu-link">
                                <div data-i18n="Products">Client</div>
                            </a>
                        </li>
                        <li className="menu-item">
                            <a href="/product" className="menu-link">
                                <div data-i18n="Products">Produtc Category</div>
                            </a>
                        </li>
                    </ul>
                </li>
