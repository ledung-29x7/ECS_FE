...
document.getElementById('layout-menu') &&
    ...
    (function () {
        ...
        let o = document.documentElement.getAttribute('data-style');
        var s,
            i =
                ...
                (window.templateCustomizer &&
                    ...
                    'light' === i
                        ? (n.classList.add('ri-sun-line'),
                          new bootstrap.Tooltip(n, { title: 'Light Mode', fallbackPlacements: ['bottom'] }))
                        : 'dark' === i
                        ? (n.classList.add('ri-moon-clear-line'),
                          new bootstrap.Tooltip(n, { title: 'Dark Mode', fallbackPlacements: ['bottom'] }))
                        : (n.classList.add('ri-computer-line'),
                          new bootstrap.Tooltip(n, { title: 'System Mode', fallbackPlacements: ['bottom'] }))),
                'system' === (s = i) &&
                ...
                setTimeout(function () {
                    ...
                    s.on('focus', function () {
                        o.hasClass('container-xxl')
                            ? (o.find(e).addClass('container-xxl'), e.removeClass('container-fluid'))
                            : o.hasClass('container-fluid') &&
                              (o.find(e).addClass('container-fluid'), e.removeClass('container-xxl'));
                    });
                }, 10),
                s.length &&
                    ((t = function (n) {
                    ...
                    s.each(function () {
                        try {
                            ...
                            s
                                ...
                                s.on('keyup', function () {
                                    '' == s.val() && i.addClass('fade').removeClass('show');
                                });
                        } catch (error) {
                            console.log(error)
                        }
