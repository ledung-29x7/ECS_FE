            ...
            function t(e) {
                ...
                !(function (t, e) {
                    ...
                    ((this._menu = this._container.querySelector('.dropdown-toggle ~ .dropdown-menu')),
                        this._menu && (e.setAttribute('aria-expanded', 'false'), (this._el = e), this._bindEvents()));
            }
            var e, n, o;
            return (
                (e = t),
                ...
                (n = [
                        ...
                        value: function () {
                            ...
                            (this._elClickEvnt = function (t) {
                                ...
                                (this._focusoutEvnt = function () {
                                    e._focusTimeout && (clearTimeout(e._focusTimeout), (e._focusTimeout = null)),
                                        ...
                                        (e._focusTimeout = setTimeout(function () {
                                            'BODY' !== document.activeElement.tagName.toUpperCase() &&
                                                t._findParent(document.activeElement, 'mega-dropdown') !==
                                                e._container &&
                                                e.close(!0);
                                        }, 100));
                                }),
                                ...
                                ((this._enterEvnt = function () {
                                    'static' !==
                                        window.getComputedStyle(e._menu, null).getPropertyValue('position') &&
                                        e.open();
                                }),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this._elClickEvnt &&
                                (this._el.removeEventListener('click', this._elClickEvnt), (this._elClickEvnt = null)),
                                this._bodyClickEvnt &&
